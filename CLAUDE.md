...
- **`controlling-documents/Zay-Marie_Press_Digital_Studies_Master_Standard_v1.22.pdf`** — Master Standard v1.22. Governs study structure, cover, PDF assembly, website package and publication (includes §16 Individual Study Preview Selection Standard). §16 fixes the preview set at exactly three pages: Table of Contents, What You Will Learn, and one further page of real substance that does not give away the study's thesis. As of v1.19, §2 (Forward Cover System) adds a Cover Art Brief step: Claude drafts a detailed written cover art description (image concept, composition, palette, lighting, symbolic content) for the publisher to hand to the illustrator, before the illustrator produces artwork — see Approval Checkpoint 3 below. As of v1.20, §6 (Body-Content Standard) fixes exact interior spacing values: body paragraphs 6pt space-after / 0pt space-before / 1.08 line spacing; Heading 1 14pt space-before / 8pt space-after; Heading 2 10pt space-before / 5pt space-after. As of v1.21, §9 (Content-Depth and Page-Length Standard) fixes the substantive-interior page count at exactly 15 pages, replacing the prior 13–17 page range; matching references updated in the Page-Count Control note (§3) and Stages 2 and 4 of the Study Development and Approval Workflow (§14). As of v1.22, new §17 (About This Study — Related-Study Distinction Standard) requires a second paragraph in every study's About This Study section, placed before the "How These Studies Relate" box: it names the specific neighbouring studies a reader might confuse this one with, states what ground each one covers that this study doesn't (or vice versa), and closes with the single narrower question this study alone answers — see the "About This Study" bullet below. Governs new studies going forward; existing studies get it when reopened or when the publisher directs a retrofit. §18/§19 (formerly §17/§18) are Locked Status and Version History. See §19 Version History in the document itself.
- **`controlling-documents/Digital_Studies_Relationship_Map_v1.9.md`** — records each study's distinct subject and its related studies (currently version 1.9, covers Studies 1–52; update it as new studies publish, bump the version number, rename the file to match, and log the change in its own version-history table — mirroring the Master Standard's `_vX.Y` filename convention). Check a proposed topic against it before recommending or writing a new study.
